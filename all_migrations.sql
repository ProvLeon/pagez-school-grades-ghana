...
-- ============================================
-- This ensures all teachers have a corresponding profile with user_type = 'teacher'
-- so that the isTeacher check in the application works correctly
...
-- 7. Teacher profiles are now automatically created when teachers are linked to auth users
-- ============================================
