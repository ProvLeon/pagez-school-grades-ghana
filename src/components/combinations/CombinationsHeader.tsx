...
import { CreateCombinationDialog } from "./CreateCombinationDialog";

interface CombinationsHeaderProps {
  totalCombinations: number;
  filteredCount: number;
  onWatchGuide: () => void;
}

export function CombinationsHeader({ totalCombinations, filteredCount, onWatchGuide }: CombinationsHeaderProps) {
  return (
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold">
                  Subject Combinations Hub
                </h1>
              </div>
              <p className="text-blue-200 text-sm lg:text-base max-w-2xl">
                Create and manage subject combinations for streamlined academic planning
              </p>
            </div>
