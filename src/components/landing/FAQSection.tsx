...
import { createFAQSchema, type FAQItem } from "@/components/seo/schemas";

const faqs: FAQItem[] = [
  {
    question: "What is e-Results GH?",
    answer: "e-Results GH is a purpose-built school management platform for Ghanaian schools. It provides BECE-standard grading, instant report sheet generation, student lifecycle management, mock exam administration, teacher portals, and powerful analytics — all in one secure, cloud-based system designed around the realities of Ghana Education Service requirements.",
  },
  {
    question: "How does the 14-day free trial work?",
    answer: "When you sign up, you get full access to all platform features for 14 days with a cap of 10 students — no payment or credit card required. After the trial, the platform enters a Soft-Lock state: your school's data is fully preserved and viewable, but new entries and edits are paused until an active subscription is in place. You can activate your plan at any point during or after the trial.",
  },
  {
    question: "How is pricing calculated?",
    answer: "Pricing is a simple flat rate of GHS 2.00 per registered student, billed annually. You only pay for the students you register — no hidden fees, no tiers. The more students you have, the more value you get from the platform.",
  },
  {
    question: "Can I pay with Mobile Money?",
    answer: "Yes. We support MTN Mobile Money, AirtelTigo Money, and Telecel Cash via our Paystack payment integration. Bank card (Visa/Mastercard) payments are also accepted. All transactions are processed securely through Paystack's encrypted payment gateway.",
  },
  {
    question: "What happens when my student limit is reached?",
    answer: "When your plan's registered student limit is reached, you'll receive an in-app notification prompting you to upgrade to the next tier or purchase a top-up allocation. Top-ups are prorated — you only pay for the remaining months in your current subscription year, so you're never overcharged.",
  },
  {
    question: "Is my school's data secure?",
    answer: "Absolutely. Your school's data is hosted on Supabase cloud infrastructure with row-level security policies, encryption at rest, and strict data isolation between schools. No other school, administrator, or third party can access your data. We follow industry best practices for data protection and privacy.",
  },
  {
    question: "Can teachers access the platform too?",
    answer: "Yes. e-Results GH has granular role-based access control. Headmasters and admins have full platform control, while teachers can be granted scoped access to enter and review scores for their specific assigned classes and subjects only — without the ability to view or modify any other school data or administrative settings.",
  },
];
