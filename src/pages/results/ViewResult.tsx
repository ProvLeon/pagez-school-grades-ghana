      ...
      <main className="container mx-auto px-4 py-6 space-y-6 w-full">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-2">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
            <Button
              ...
              className="rounded-xl bg-slate-50/50 hover:bg-slate-100 dark:bg-slate-800/50 dark:hover:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 transition-all duration-300 hover:-translate-y-[1px] hover:shadow-sm font-semibold flex-1 sm:flex-none"
            >
            ...
            <Button
              ...
              className="rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground shadow-[0_2px_10px_-3px_rgba(6,81,237,0.2)] hover:shadow-[0_8px_30px_-4px_rgba(6,81,237,0.25)] transition-all duration-300 hover:-translate-y-[1px] flex-1 sm:flex-none font-semibold border-0"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-card border border-slate-100 dark:border-border shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] p-5 flex flex-col justify-center group transition-all duration-300 hover:border-primary/30 hover:-translate-y-[1px] hover:shadow-[0_8px_30px_-4px_rgba(6,81,237,0.15)]">
